...
**Frisco, TX** | (972) 804-9185 | harrib93@icloud.com | theblakeharrison.com

## Summary
Management Information Systems graduate who builds, deploys, and operates production systems end to end. Experience spanning workflow automation, API integration, systems troubleshooting, and live monitoring for real business operations.
...
**Systems & Operations** — Workflow automation, systems troubleshooting, API integration, testing & debugging, workflow documentation, process improvement, monitoring

**Platforms & Infrastructure** — Git, Linux, Docker, Nginx, Netlify, PostgreSQL, Google Analytics, Google Tag Manager

**AI & Developer Tooling** — Claude Code, Cursor, OpenClaw, MetaTrader 5

**Development & Data** — Python, SQL, TypeScript/JavaScript, React, Next.js, FastAPI, pandas, PowerShell, Excel
...
### Additional Projects
- ClipBot: Python/FastAPI pipeline that transcribes long-form video with faster-whisper, selects clip-worthy moments from the transcript, and cuts captioned short-form videos with FFmpeg
- PowerShell dashboard that risk-scores listening TCP services on a host
- Debian home-lab appliance running Pi-hole, Nginx, monitoring, and a FastAPI dashboard
...
- Dean's Honor Roll, Oklahoma State University (Fall 2024) and University of Arkansas (2022)
